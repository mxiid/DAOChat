...
export default function ChatbotPage() {
  ...
  return (
    <div className={`flex flex-col min-h-[100dvh] ${isDarkMode ? 'dark bg-gray-900' : 'bg-white'}`}>
      <header className="bg-transparent backdrop-blur-sm border-b border-gray-200/40 dark:border-gray-700/40 p-4 font-bold flex items-center justify-between sticky top-0 z-50">
        <div className="flex items-center">
          ...
          />
          <span className="text-lg text-black dark:text-white">DAO Chat</span>
        </div>
        <Button 
          variant="outline" 
          size="sm" 
          onClick={toggleTheme} 
          className="bg-white/10 hover:bg-white/20 dark:bg-gray-800/10 dark:hover:bg-gray-700/20 border-gray-200/40 dark:border-gray-700/40 hover:border-gray-300 dark:hover:border-gray-600 transition-colors text-black dark:text-white"
        >
